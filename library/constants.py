...
# 1:Using Global Search; 2: Using Category Search
MODE_OF_SEARCH = 1  
# False:Script will not scrap product page; True:Script will scrap product page
PRODUCT_PAGE_SCRAPE_MODE = False
